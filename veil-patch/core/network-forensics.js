 ...
 *  3. Computes fast checksum hashes and payload byte sizes for forensic audit logs
 *     (a djb2 checksum for tamper-evidence, not a cryptographic guarantee).
...
(function () {
  ...
  // Fast synchronous djb2 checksum for tamper-evident audit logging — NOT a cryptographic
  // hash (no preimage/collision resistance). Good enough to fingerprint a logged payload;
  // do not rely on it for anything security-critical.
